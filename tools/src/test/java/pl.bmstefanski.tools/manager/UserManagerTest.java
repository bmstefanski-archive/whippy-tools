...
public class UserManagerTest {
    ...
    @Test(expected = UnimplementedOperationException.class) // waiting for implementation https://github.com/seeseemelk/MockBukkit/blob/master/src/main/java/be/seeseemelk/mockbukkit/ServerMock.java#L876
